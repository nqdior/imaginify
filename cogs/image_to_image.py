...
class IMG2IMG(commands.Cog):
    ...
    ### Img2imgコマンドの実装
    @slash_command(name="img2img", description="Stable Diffusionを使用して画像を生成します。")
    async def img2img(self, ctx, 
                      file: Option(discord.Attachment, "画像生成に使用する画像を添付してください。", required=True, type=discord.Attachment, content_type="image/*"),
